...
def find_price_range():
    for laptop in laptops:
        for laptop_size in laptop['types']:
            cheapest_laptop = min(laptop_size['price'])
            priciest_laptop = max(laptop_size['price'])
            print('Cheapest: ' + laptop['productName'],
                  laptop_size['screen_size'], cheapest_laptop)
            print('Most Expensive:  ' + laptop['productName'],
                  laptop_size['screen_size'], priciest_laptop)
